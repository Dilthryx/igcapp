...
const IGCNominas = () => {
  ...
  const mainButtons = [
    ...
    { label: 'SUMATORIO EMPRESAS', icon: BarChart3 },
    { label: 'SUMATORIO OBRAS', icon: TrendingUp },
    { label: 'PUESTOS', icon: Briefcase },
    { label: 'USUARIOS', icon: Users },
    { label: 'PROVEEDORES', icon: Truck },
    { label: 'EMPLEADOS', icon: UserCheck },
    { label: 'CONCEPTOS', icon: Grid3x3 },
    { label: 'NOMINAS JORNAL', icon: FileText },
    { label: 'DESTAJO', icon: ClipboardList },
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-2 gap-4">
            ...
            <button
              onClick={() => console.log('Clicked: CUENTA')}
